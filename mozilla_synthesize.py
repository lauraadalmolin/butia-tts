...
ROOT_PATH = TTS_PATH
MODEL_PATH = os.path.join('/home/laura/Documents/at-home-tts/tts_models/checkpoint_261000.pth.tar')
CONFIG_PATH =  os.path.join('/home/laura/Documents/at-home-tts/tts_models/config.json')
OUT_FOLDER = os.path.join(ROOT_PATH,'AudioSamples/benchmark_samples/')
CONFIG = load_config(CONFIG_PATH)
VOCODER_MODEL_PATH = os.path.join('/home/laura/Documents/at-home-tts/wavernn_models/checkpoint_433000.pth.tar')
VOCODER_CONFIG_PATH = os.path.join('/home/laura/Documents/at-home-tts/wavernn_models/config.json')
